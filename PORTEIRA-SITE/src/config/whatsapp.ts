...
// Configuração central do WhatsApp da pizzaria.
// Usado por App.tsx (página /contato), pelo checkout (Pages/Pedido.tsx) e por services/emailService.ts.
...
export function formatarWhatsApp(numero: string): string {
  ...
  // Separa em DDI (2), DDD (2), primeira parte (4 ou 5 dígitos) e final (4)
